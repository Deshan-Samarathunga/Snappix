...
export default function CommunityPage() {
  ...
  // Permission logic: show ✚ button if user is a contributor or moderator
  const isModerator = community.createdBy === currentUserEmail;
  const isContributor = community.contributors?.includes(currentUserEmail);
  const canAddCourse = isModerator || isContributor;
